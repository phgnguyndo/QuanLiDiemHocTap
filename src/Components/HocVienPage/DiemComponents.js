import { FormControl, FormLabel, Input, Button, useDisclosure, Select, Text } from "@chakra-ui/react";
...
const DiemComponent = (props)=>{
    ...
    return(
        <>
            <Tr >
                <Td position={"relative"} textAlign={"center"}>{props.MaHocPhan}</Td>
                ...
                <Td position={"relative"} textAlign={"center"}>
                    <Button colorScheme="green" mr={3} onClick={onSubmitDeleteModalOpen}>
                    Xóa
                    </Button>
                    <Modal
                            isCentered
